...
const HeroSection = () => {
  return (
    <section className='relative lg:min-h-screen lg:pt-26 lg:px-28 bg-[#0A0A0B]' id='hero-section'>
      ...
      <div className="absolute overflow-hidden top-30 pointer-events-none right-[10%] size-100 rounded-full bg-linear-30 opacity-10 blur-3xl from-primary to-greytext"></div>
        ...
        <h1 className='lg:text-8xl animate-sink-in font-epilogue font-black text-white'>Hi, I&apos;m <br /> <span className='text-primary'>Kaif Shaikh</span></h1>
        <span className=' text-greytext text-3xl animate-sink-intrigger font-semibold font-dm-sans'>Full Stack Developer & <br/> <span className='text-accent'>Machine Learning</span> Enthusiast</span>
